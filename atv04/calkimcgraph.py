...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        ### Push Button 4 -> Determina a média dos dados
        ...
        ### Push Button 5 -> Mostra a estatística dos dados
        self.pushButton_5 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_5.setGeometry(QtCore.QRect(635, 490, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_5.setFont(font)
        self.pushButton_5.setStyleSheet("background-color: rgb(255, 140, 130);\n" "color: rgb(0, 85, 255);")
        ...
        self.pushButton_4.clicked.connect(self.mediaDados)
        self.pushButton_5.clicked.connect(self.showDados)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_5.setText(_translate("MainWindow", "Dados"))
...
## Função para determinar a média dos dados armazenados no Banco de Dados
    def mediaDados(self):
        imcs = []
        ### Conectando e preparando o banco de dados
...
## Método para mostrar os dados armazenados
    def showDados(self):
        imcs = []
        xn = []
        n = 1
        ...
        for dado in dados:
            ...
            n += 1
        fig = pg.plot()
        fig.setWindowTitle("IMCs Armazenados")
        barg = pg.BarGraphItem(x=xn, height=imcs, width=0.6, brush='g')
        fig.addItem(barg)
